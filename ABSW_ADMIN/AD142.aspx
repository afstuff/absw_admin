        ...
        <tr>
            <td colspan="7" valign="top">
                <table align="left" width="100%">
                    ...
                    <tr>
                        <td align="right" valign="top"><asp:Label ID="lblStartNo" Text="Start #:" runat="server"></asp:Label>&nbsp;</td>
                        <td valign="top"><asp:TextBox ID="txtStartNo" Enabled="true" Width="100" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                                        <tr>
                        <td align="right" valign="top"><asp:Label ID="lblEndNo" Text="End  #:" runat="server"></asp:Label>&nbsp;</td>
                        <td valign="top"><asp:TextBox ID="txtEndNo"  Enabled="true" Width="100" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top"><asp:Label ID="lblStartType" Text="Start Type:" runat="server"></asp:Label>&nbsp;</td>
                        <td valign="top"><asp:TextBox ID="txtStartType" Enabled="true" Width="100" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                                        <tr>
                        <td align="right" valign="top"><asp:Label ID="lblEndType" Text="End Type:" runat="server"></asp:Label>&nbsp;</td>
                        <td valign="top"><asp:TextBox ID="txtEndType"  Enabled="true" Width="100" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                      <td colspan="5" valign="top">
