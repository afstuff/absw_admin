...
Partial Public Class AD142
    ...
    Private Sub Print_This()
        ...
        Dim ScreenName As String = Request.QueryString("param7")
        ...
        '*********************************************************
        'Set screen variables nice and easy
        '*********************************************************
        lblStartNo.Text = "Start " & ScreenName & " #"
        lblEndNo.Text = "End " & ScreenName & " #"

        lblStartType.Text = "Start " & ScreenName & " Type"
        lblEndType.Text = "End " & ScreenName & " Type"
        ...
        Try
            ...
            crParameterFieldDefinition = crParameterFieldDefinitions.Item(Request.QueryString("param1"))
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterValues.Add(crParameterDiscreteValue)

            crParameterDiscreteValue2.Value = ValidDate(txtEndDate.Text)
            crParameterFieldDefinitions = oRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFieldDefinitions.Item(Request.QueryString("param2"))
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterValues.Add(crParameterDiscreteValue2)


            crParameterDiscreteValue3.Value = Trim(txtStartNo.Text)
            crParameterFieldDefinitions = oRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFieldDefinitions.Item(Request.QueryString("param3"))
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterValues.Add(crParameterDiscreteValue3)


            crParameterDiscreteValue4.Value = Trim(txtEndNo.Text)
            crParameterFieldDefinitions = oRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFieldDefinitions.Item(Request.QueryString("param4"))
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterValues.Add(crParameterDiscreteValue4)

            crParameterDiscreteValue5.Value = Trim(txtStartType.Text)
            crParameterFieldDefinitions = oRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFieldDefinitions.Item(Request.QueryString("param5"))
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterValues.Add(crParameterDiscreteValue5)


            crParameterDiscreteValue6.Value = Trim(txtEndType.Text)
            crParameterFieldDefinitions = oRpt.DataDefinition.ParameterFields
            crParameterFieldDefinition = crParameterFieldDefinitions.Item(Request.QueryString("param6"))
            crParameterValues = crParameterFieldDefinition.CurrentValues
            crParameterValues.Add(crParameterDiscreteValue6)
